...
function ClearFilter({name}:{name?:string}) {
  ...
  return (
    <div
    className="flex flex-row md:gap-0 gap-2 rounded-md p-2 md:p-1 justify-center items-center my-1 border-[1px] bg-primaryLight border-dark w-fit mr-auto  focus:cursor-pointer"
